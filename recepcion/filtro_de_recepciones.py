...
class CuentasAnuales(YearArchiveView):
	#queryset = Recepcion.objects.all()
	paginate_by = 25
	template_name='recepcion/cuentas/cuentasXpagar_ano.html'
	...
	def get(self, request, *args, **kwargs):
		...
		self.object = queryset
		return super(CuentasAnuales, self).get(request, *args, **kwargs)
	def get_context_data(self, **kwargs):
		context = super(CuentasAnuales, self).get_context_data(**kwargs)
		context['form'] = self.object
		context['q']= self.q
		return context 
	def get_queryset(self):
...
class CuentasMensuales(MonthArchiveView):
	...
	template_name='recepcion/cuentas/cuentasXpagar_mes.html'
	paginate_by = 25
	date_field = 'fecha_agregado'
	month_format = '%m'
	context_object_name='form'
	...
	def get(self, request, *args, **kwargs):
		...
		self.object = queryset
		return super(CuentasMensuales, self).get(request, *args, **kwargs)
	def get_context_data(self, **kwargs):
		context = super(CuentasMensuales, self).get_context_data(**kwargs)
		context['form'] = self.object
		context['q']= self.q
		return context 
	def get_queryset(self):
...
class CuentasDiarias(DayArchiveView):
	queryset=Recepcion.objects.order_by('fecha_llegada')
	template_name='recepcion/cuentas/cuentasXpagar_dia.html'
	paginate_by = 25
	date_field = 'fecha_agregado'
	context_object_name='form'
	month_format = '%m'
	...
	def get_context_data(self, **kwargs):
		context = super(CuentasDiarias, self).get_context_data(**kwargs)
		context['form'] = self.object
		context['q']= self.q
		return context 
	def get_queryset(self):
